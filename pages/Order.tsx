...
import { CheckCircle2, Loader2, ArrowRight, ShieldCheck, Instagram, Copy, Truck } from 'lucide-react';
...
const Order: React.FC = () => {
  ...
  const baseDeliveryCharge = formData.city === 'Dhaka' ? 80 : 120;
            ...
            >
              <div className="lg:col-span-7 bg-brand-card p-10 rounded-3xl shadow-soft border border-brand-border">
                <div className="mb-10">
                  ...
                  <p className="text-brand-secondary text-sm">Please fill in your details to complete the purchase.</p>
                </div>
                    ...
                    <div className="space-y-2">
                       ...
                       <div className="flex items-center gap-2 mt-2">
                         <p className="text-xs text-brand-muted">
                           Standard Delivery: {baseDeliveryCharge} BDT
                         </p>
                         {hasFreeDelivery && (
                           <div className="flex items-center gap-1 text-[10px] font-bold text-green-600 uppercase bg-green-50 px-2 py-0.5 rounded">
                             <Truck size={12}/> Free Delivery Active
                           </div>
                         )}
                       </div>
                    </div>
                      ...
                      <div key={item.productId} className="flex justify-between items-center text-sm">
                         <div className="flex items-center space-x-3">
                           ...
                           <div className="flex flex-col">
                            ...
                            {item.isFreeDelivery && <span className="text-[9px] font-bold text-green-600 uppercase">Free Delivery</span>}
                           </div>
                         </div>
                         <span className="text-brand-primary font-bold">{formatPrice(item.price * item.quantity)}</span>
                      </div>
                    ))}
                  </div>
