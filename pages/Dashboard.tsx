    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-24 space-y-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between space-y-6 md:space-y-0">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <Link to="/products" className="flex items-center space-x-2 px-6 py-3 bg-white/5 hover:bg-white/10 text-white rounded-xl font-bold transition-all border border-white/10">
            <List size={18} />
            <span>Products</span>
          </Link>
          <Link to="/add-product" className="flex items-center space-x-2 px-6 py-3 bg-brand text-white rounded-xl font-bold transition-all glow-hover">
            <Plus size={18} />
            <span>New Item</span>
          </Link>
